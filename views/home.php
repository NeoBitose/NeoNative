  ...
  <div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-between py-3 mb-4 border-bottom">
      <div class="col-md-3 mb-2 mb-md-0">
        <a href="/" class="d-inline-flex link-body-emphasis text-decoration-none fw-semibold">
          <h5 class="m-0">NeoNative</h5>
        </a>
      </div>
    ...
    <div class="px-md-5 py-md-5 my-md-5 px-1 py-1 my-4 text-center">
      ...
      <div class="col-lg-6 mx-auto">
        <div class="d-grid gap-2 d-sm-flex justify-content-center">
          ...
          <a href="https://github.com/NeoBitose/Template-MVC">
            <button type="button" class="btn btn-outline-secondary btn-lg px-4 w-md-100">Docs</button>
          </a>
        </div>
      </div>
    </div>
