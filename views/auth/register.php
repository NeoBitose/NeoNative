...
<body>
  <section class="d-flex justify-content-center align-items-center"
    style="min-height: 100vh;background-color: hsl(0, 0%, 96%)">
    <!-- Jumbotron -->
            ...
            <div class="card border-0">
              <div class="card-body py-5 px-md-5">
                <form action="register" method="post">
                  ...
                  <h1 class="text-secondary text-center mb-5 fw-bold">Register</h1>
                  <!-- Email input -->
                  ...
                  <div class="d-flex justify-content-center">
                    <button type="submit" data-mdb-button-init data-mdb-ripple-init
                      class="btn btn-secondary btn-lg btn-block mb-4 align-items-center">
                      Sign In
                    </button>
                  </div>
                  <p class="text-center">Sudah punya akun ? <a href="login" class="text-secondary">Masuk</a></p>
                </form>
              </div>
            </div>
          </div>
